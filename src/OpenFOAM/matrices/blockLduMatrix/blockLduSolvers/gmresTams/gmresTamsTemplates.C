...
inline void gmresTams<nScalar, nVector>::givensRotation
(
    const scalar& h,
    const scalar& beta,
    scalar& c,
...
template <int nScalar, int nVector>
gmresTams<nScalar, nVector>::gmresTams
(
...
template <int nScalar, int nVector>
label gmresTams<nScalar, nVector>::solve
(
...
) const
{
    ...
    if (this->mesh_.template foundObject<volScalarField>("cellMask")) //if(this->mesh_.objectRegistry::foundObject<volScalarField>("cellMask"))
    {
        ...
        //volScalarField cellMask = this->mesh_.objectRegistry::lookupObject<volScalarField>("cellMask");
