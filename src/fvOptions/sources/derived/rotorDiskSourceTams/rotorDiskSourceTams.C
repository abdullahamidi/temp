...
namespace Foam
{
    namespace fv
    {
        defineTypeNameAndDebug(rotorDiskSourceTams, 0);
        addToRunTimeSelectionTable(option, rotorDiskSourceTams, dictionary);
    }
}
...
const Foam::Enum
<
    Foam::fv::rotorDiskSourceTams::geometryModeType
>
Foam::fv::rotorDiskSourceTams::geometryModeTypeNames_
({
...
const Foam::Enum
<
    Foam::fv::rotorDiskSourceTams::inletFlowType
>
Foam::fv::rotorDiskSourceTams::inletFlowTypeNames_
({
...
void Foam::fv::rotorDiskSourceTams::checkData()
{
    // Set inflow type
...
void Foam::fv::rotorDiskSourceTams::setFaceArea(vector& axis, const bool correct)
{
    area_ = 0.0;
...
void Foam::fv::rotorDiskSourceTams::createCoordinateSystem()
{
...
void Foam::fv::rotorDiskSourceTams::constructGeometry()
{
...
Foam::tmp<Foam::vectorField> Foam::fv::rotorDiskSourceTams::inflowVelocity
(
...
Foam::fv::rotorDiskSourceTams::rotorDiskSourceTams
(
    const word& name,
...
:
    ...
    rhoRef_(1.0),
    //diameterRef_(1.0), //NEW LINE
    refVelEta_(0.0), //NEW LINE
    omega_(0.0),
    nBlades_(0),
    inletFlow_(ifLocal),
    inletVelocity_(Zero),
    ...
    coordSys_(),
    rMax_(0.0),
    trim_(trimModelTams::New(*this, coeffs_)),
...
void Foam::fv::rotorDiskSourceTams::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldi
)
...
bool Foam::fv::rotorDiskSourceTams::read(const dictionary& dict)
{
    if (fv::cellSetOption::read(dict))
    {
        ...
        //coeffs_.readEntry("diameterRef", diameterRef_); //NEW LINE
        coeffs_.readEntry("refVelEta", refVelEta_); //NEW LINE
