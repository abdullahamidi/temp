...
namespace Foam
{
    makeLimitedSurfaceInterpolationTypeScheme(wPureFirstOrder, wPureFirstOrderLimiter, NVDTVD, null, scalar)
    ...
    // vectors and tensors
    makeLimitedReconstructionScheme(wPureFirstOrder, wPureFirstOrderLimiter)
}
