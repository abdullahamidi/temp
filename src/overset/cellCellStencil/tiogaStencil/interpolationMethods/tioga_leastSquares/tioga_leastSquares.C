...
{
    defineTypeNameAndDebug(tioga_leastSquares, 0);
    addToRunTimeSelectionTable(cellCellStencil, tioga_leastSquares, mesh);
}
}

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::cellCellStencils::tioga_leastSquares::stencilWeights
(
    const point& sample,
...
Foam::cellCellStencils::tioga_leastSquares::tioga_leastSquares
(
    const fvMesh& mesh,
