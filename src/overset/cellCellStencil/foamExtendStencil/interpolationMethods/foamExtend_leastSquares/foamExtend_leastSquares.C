...
#include "foamExtend_leastSquares.H"
...
{
    defineTypeNameAndDebug(foamExtend_leastSquares, 0);
    addToRunTimeSelectionTable(cellCellStencil, foamExtend_leastSquares, mesh);
}
}

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::cellCellStencils::foamExtend_leastSquares::stencilWeights
(
    const point& sample,
...
Foam::cellCellStencils::foamExtend_leastSquares::foamExtend_leastSquares
(
    const fvMesh& mesh,
