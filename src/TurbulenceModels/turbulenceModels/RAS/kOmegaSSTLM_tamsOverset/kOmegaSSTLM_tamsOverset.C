...
tmp<volScalarField> kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::F1
(
...
) const
{
    ...
    return max(kOmegaSST_tamsOverset<BasicTurbulenceModel>::F1(CDkOmega), F3);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*kOmegaSST_tamsOverset<BasicTurbulenceModel>::Pk(G);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *kOmegaSST_tamsOverset<BasicTurbulenceModel>::epsilonByk(F1, gradU);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::Fthetat
(
...
kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::kOmegaSSTLM_tamsOverset
(
...
:
    kOmegaSST_tamsOverset<BasicTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
bool kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::read()
{
    if (kOmegaSST_tamsOverset<BasicTurbulenceModel>::read())
    {
...
template<class BasicTurbulenceModel>
void kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...

    {
        ...
        volScalarField ReThetatBefore = ReThetat_;  //// S.A {Oct. 2024}
        solve(ReThetatEqn);
        if(this->mesh_.template foundObject<volScalarField>("cellMask"))
        {
            ...
            ReThetat_ = ReThetatBefore + cellMask*(ReThetat_ - ReThetatBefore);
        }
    ////         
...

    {
        ...
        volScalarField gammaIntBefore = gammaInt_;  //// S.A {Oct. 2024}
        solve(gammaIntEqn);
        if(this->mesh_.template foundObject<volScalarField>("cellMask"))
        {
            //Info<<"Set the solution increment to zero for hole and interpolated cells"<<endl;
            volScalarField cellMask = this->mesh_.template lookupObject<volScalarField>("cellMask");
            gammaInt_ = gammaIntBefore + cellMask*(gammaInt_ - gammaIntBefore);
        }        
...
template<class BasicTurbulenceModel>
void kOmegaSSTLM_tamsOverset<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    // Correct k and omega
    kOmegaSST_tamsOverset<BasicTurbulenceModel>::correct();
